...
启蒙上位机软件采用面向对象的设计方法，利用 **C++编程语言** 和 **Qt Creator 4.5.1开发平台**进行设计编写。<br>
...
&#8195;&#8195;启蒙上位机3.0版在保留上述功能的基础上，又新增了 **隐藏接收** 和 **数据实时可视化** 的功能。**发送新行**功能是指在待发送字符串后面加“\n”，为了实现数据实时可视化以及接收完整数据，**程序根据“\n”出现的位置将接收到的数据划分为多行,故建议使用 \n 而非 \r\n 作为数据的结尾,以免出现偶尔空行等异常情况**。<br>
